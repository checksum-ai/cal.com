...
test(
  defineChecksumTest("Book on column layout", "LAYOUT_COLUMN_001"),
  {
    annotation: {
      type: "IntentionallyBroken",
      description: {
        change:
          "Should locate correct element either by locator '[data-testid=\"toggle-group-item-column_view\"]' or any other valid way to click it.",
      },
    },
  },
  async ({ page, users }) => {
